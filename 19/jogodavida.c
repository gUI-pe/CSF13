...
int main()
{
    ...
    // essa chamada de funcao le o conteudo de um arquivo txt e carrega os dados em uma matriz e retorna
    // referencia para uma matriz alocada dinamicamente cujo conteudo foi carregado do arquivo .txt
    // é enviado o arquivo, o endereco de nl e nc, porque a função pede por ponteiros e já que nl
    // e nc nao sao ponteiros mandamos o endereco deles, dentro do endereco deles esta o cont deles :)
...
void jogo(int **matriz, int nl, int nc, int iter)
{
    ...
    // porque os valores da matriz seriam alterados o que iria comprometer o calculo dos
    // valores que ainda não haviam sido calculados
    ...
    for(k=0; k<iter; k++)
    {
        ...
        // ́para que as
        // duas matrizes sejam iguais para a próxima iteracao
